...
function showMessage(seconds,card_1,card_2) {
    if (card_1){
        // message untuk card messasge 
        const pesan = [
            "Hallo sayangku",
        ...
        // let message2ToShow = pesan2[currentMessageIndex];
        document.getElementById("content-1").innerHTML = messageToShow;
    ...
    if(card_2){
        ...
        const pesan2 = [
            "Hallo sayangku",
            "Aku harap kamu bisa baca pesan ini balablabla....",
            "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit nulla sapiente minus, impedit sunt eligendi ex. Quo ipsum tenetur eveniet, illum ratione aut nobis ea sit deserunt, vero corrupti laborum!Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit nulla sapiente minus, impedit sunt eligendi ex. Quo ipsum tenetur eveniet, illum ratione aut nobis ea sit deserunt, vero corrupti laborum!",
            "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit nulla sapiente minus, impedit sunt eligendi ex. Quo ipsum tenetur eveniet, illum ratione aut nobis ea sit deserunt, vero corrupti laborum!",
            "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit nulla sapiente minus, impedit sunt eligendi ex. Quo ipsum tenetur eveniet, illum ratione aut nobis ea sit deserunt, vero corrupti laborum!",
            "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit nulla sapiente minus, impedit sunt eligendi ex. Quo ipsum tenetur eveniet, illum ratione aut nobis ea sit deserunt, vero corrupti laborum!",
        ];
        ...
        if (contentElement2) {
            contentElement2.innerHTML = message2ToShow;
        }

        currentMessageIndex = (currentMessageIndex + 1) % pesan2.length;
        return message2ToShow;
    }
}
